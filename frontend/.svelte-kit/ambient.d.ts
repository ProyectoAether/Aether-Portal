...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_fuzzysort: string;
	...
	export const npm_package_dependencies_vitest: string;
	export const LC_NAME: string;
	export const SHELL: string;
	export const NODE_PATH: string;
	export const npm_package_version: string;
	export const npm_package_devDependencies_jsdom: string;
	export const npm_package_dependencies_js_sha256: string;
	...
	export const npm_package_dependencies_svelte_countup: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SHLVL: string;
		npm_package_dependencies_fuzzysort: string;
		HOME: string;
		OLDPWD: string;
		...
		npm_package_dependencies_vitest: string;
		LC_NAME: string;
		SHELL: string;
		NODE_PATH: string;
		npm_package_version: string;
		npm_package_devDependencies_jsdom: string;
		npm_package_dependencies_js_sha256: string;
		...
		npm_package_dependencies_svelte_countup: string;
